...
function useGoogleAutocomplete(_a) {
    var apiKey = _a.apiKey, query = _a.query, _b = _a.type, type = _b === void 0 ? "places" : _b, _c = _a.debounceMs, debounceMs = _c === void 0 ? 400 : _c, throttleMs = _a.throttleMs, _d = _a.options, options = _d === void 0 ? {} : _d;
    ...
    React.useEffect(function () {
        ...
        var theFn = function () {
            ...
            var components = options.components
                ...
                : "";
            var url = cors + "https://maps.googleapis.com/maps/api/place/autocomplete/json?input=" + query + types + language + location + radius + components + strictbounds + offset + "&key=" + apiKey + "&sessiontoken=" + sessionToken.current;
        ...
        debouncedFn.current = throttleMs ? debounceWithThrottle(theFn, debounceMs, throttleMs, false, true) : debounce(theFn, debounceMs);
        debouncedFn.current();
    }, [
        query,
        debounceMs,
